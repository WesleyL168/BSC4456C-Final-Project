...
Here, I calculated the percentage plastic type for each country. The first table contains total count for each plastic type. The second table contains the percentage of each plastic type out of the grand total amount. For simplicity, I limited to the top 10 countries with the most amount of plastics.
